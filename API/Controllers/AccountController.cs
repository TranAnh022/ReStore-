...
namespace API.Controllers
{
    public class AccountController : BaseApiController
    {
        ...
        {
            var user = await _userManager.FindByNameAsync(User.Identity.Name);  //take the parameter from the claims

            var userBasket = await RetrievedBasket(User.Identity.Name);
