    ...
    public partial class OrderEntityAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasetItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BasetItems_Baskets_BasketId",
                        column: x => x.BasketId,
                        principalTable: "Baskets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasetItems_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BasetItems_BasketId",
                table: "BasetItems",
                column: "BasketId");

            migrationBuilder.CreateIndex(
                name: "IX_BasetItems_ProductId",
                table: "BasetItems",
                column: "ProductId");
